  ...
  : handle_(0)
{
  ...
  case context::sslv3:
    handle_ = ::SSL_CTX_newSIO(::SSLv3_method());
    break;
  case context::sslv3_client:
    handle_ = ::SSL_CTX_newSIO(::SSLv3_client_method());
    break;
  case context::sslv3_server:
    handle_ = ::SSL_CTX_newSIO(::SSLv3_server_method());
    break;
  case context::tlsv1:
    handle_ = ::SSL_CTX_newSIO(::TLSv1_meth());
    break;
  case context::tlsv1_client:
    handle_ = ::SSL_CTX_newSIO(::TLSv1_client_method());
    break;
  case context::tlsv1_server:
    handle_ = ::SSL_CTX_newSIO(::TLSv1_server_method());
    break;
  case context::sslv23:
    handle_ = ::SSL_CTX_newSIO(::SSLv23_method());
    break;
  case context::sslv23_client:
    handle_ = ::SSL_CTX_newSIO(::SSLv23_client_method());
    break;
  case context::sslv23_server:
    handle_ = ::SSL_CTX_newSIO(::SSLv23_server_method());
    break;
#if defined(SSL_TXT_TLSV1_1)
  case context::tlsv11:
    handle_ = ::SSL_CTX_newSIO(::TLSv1_1_method());
    break;
  case context::tlsv11_client:
    handle_ = ::SSL_CTX_newSIO(::TLSv1_1_client_method());
    break;
  case context::tlsv11_server:
    handle_ = ::SSL_CTX_newSIO(::TLSv1_1_server_method());
    break;
  ...
  case context::tlsv12:
    handle_ = ::SSL_CTX_newSIO(::TLSv1_2_method());
    break;
  case context::tlsv12_client:
    handle_ = ::SSL_CTX_newSIO(::TLSv1_2_client_method());
    break;
  case context::tlsv12_server:
    handle_ = ::SSL_CTX_newSIO(::TLSv1_2_server_method());
    break;
